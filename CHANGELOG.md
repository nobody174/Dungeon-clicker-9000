...
Also includes a real bug fix surfaced by the first round of real-device
Android testing done ahead of a Google Play Store submission, and a
terminology consistency fix — see Fixed/Changed below.
